...
{ SP_SHADOW_GIANT, {
    ...
    {},
    {},
    { JOB_BERSERKER, JOB_ENCHANTER, JOB_EARTH_ELEMENTALIST,
      JOB_NECROMANCER, JOB_ICE_ELEMENTALIST, JOB_TRANSMUTER, JOB_SKALD,
      JOB_FIGHTER },
    { SK_UNARMED_COMBAT, SK_AXES, SK_POLEARMS, SK_STAVES, SK_SLINGS },
} },
